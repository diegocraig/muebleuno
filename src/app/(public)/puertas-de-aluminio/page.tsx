...
export const metadata: Metadata = {
  title: 'Puertas de Aluminio | Mueble UNO',
  description: 'Fabricación e instalación de puertas de aluminio a medida. Calidad y diseño para viviendas y proyectos de construcción.',
}

export const revalidate = 0

export default async function PuertasDeAluminioPage() {
  const [config, servicios, pasos, materiales, fotos] = await Promise.all([
    ...
    prisma.medidaServicio.findMany({ where: { pagina: 'puertas', activo: true }, orderBy: { orden: 'asc' } }),
    ...
    prisma.medidaFoto.findMany({ where: { pagina: 'puertas', activo: true }, orderBy: { orden: 'asc' } }),
  ])
      ...
      {servicios.length > 0 && (
        <section className="py-16 px-4 bg-gris-fondo">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-center text-gris-medio mb-10">Puertas y aberturas de aluminio para todo tipo de proyecto</p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="bg-gris-oscuro text-white rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1">
              ...
              <a href={`https://wa.me/5491173670283?text=${encodeURIComponent(config.whatsappMsg)}`}
