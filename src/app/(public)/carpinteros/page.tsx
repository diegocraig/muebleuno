...
export const metadata: Metadata = {
  title: 'Carpinteros | Mueble UNO',
  description: 'Servicio de carpintería a medida. Diseño y fabricación de muebles, placards y soluciones de madera para viviendas y proyectos.',
}
...
export default async function CarpinterosPage() {
  const [config, servicios, pasos, materiales, fotos] = await Promise.all([
    ...
    prisma.medidaServicio.findMany({ where: { pagina: 'carpinteros', activo: true }, orderBy: { orden: 'asc' } }),
    ...
    prisma.medidaFoto.findMany({ where: { pagina: 'carpinteros', activo: true }, orderBy: { orden: 'asc' } }),
  ])
      ...
      {servicios.length > 0 && (
        <section className="py-16 px-4 bg-gris-fondo">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-center text-gris-medio mb-10">Soluciones de carpintería para viviendas y proyectos</p>
